...
long-range coupling near strength one tenth, and a two-rate convergence law.
...
aggregations (Appendix~\ref{app:repro}), every capacity cell above
$C = \capcappedfrom$ stopping at an iteration cap, the fitted convergence
