...
\texttt{fig\_unet\_architecture}); three are Ti\emph{k}Z schematics drawn in
the source.
...
\texttt{thesis/sections/}, written there by one of the twelve generators
...
\texttt{make\_ref\_energy} is the thirteenth name and writes no macro at all:
